...
function Page() {
    ...
    const onSubmithandler = async (e)=>{
        ...
        const response = await axios.post('/api/blog',formData);
             if (response.data.success) {
                  ...
                  setImage(false);
                  setData({title: '', description: '', category: 'Startup', author: 'Alex Bennett', authorImg: '/author_img.png'})
             }
             else {
                toast.error("Error");
             }
  ...
  return (
    <>
      <form onSubmit={onSubmithandler} className=' pt-5 px-5 sm:pt-12 sm:pl-16 mb-2'>
